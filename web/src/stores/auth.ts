...
export const useAuthStore = defineStore('auth', () => {
  ...
  // always allowed; manager gets add/edit/delete by default; 'export'
  // (reports bulk CSV) needs an explicit grant regardless of role; staff
  // needs an explicit grant for anything beyond view.
